...
export const getPostsForUser = (requestingUserId) => postModel.getAllPostsForUser(requestingUserId);
...
export const softRemovePost = (userId, postId) => postModel.hidePost(userId, postId);
